...
@Component({
  selector: 'app-show-view-history-processed-user',
  templateUrl: './show-view-history-processed-user.component.html',
  styleUrls: ['./show-view-history-processed-user.component.css']
})
export class ShowViewHistoryProcessedUserComponent implements OnInit ,OnDestroy {
