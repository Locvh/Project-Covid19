...
@Component({
  selector: 'app-show-view-history-feedback-user',
  templateUrl: './show-view-history-feedback-user.component.html',
  styleUrls: ['./show-view-history-feedback-user.component.css']
})
export class ShowViewHistoryFeedbackUserComponent implements OnInit ,OnDestroy {
