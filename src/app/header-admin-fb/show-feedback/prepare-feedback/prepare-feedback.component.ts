...
@Component({
  selector: 'app-prepare-feedback',
  templateUrl: './prepare-feedback.component.html',
  styleUrls: ['./prepare-feedback.component.css']
})
export class PrepareFeedbackComponent implements OnInit , OnDestroy {
