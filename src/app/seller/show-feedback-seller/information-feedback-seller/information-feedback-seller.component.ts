...
@Component({
  selector: 'app-information-feedback-seller',
  templateUrl: './information-feedback-seller.component.html',
  styleUrls: ['./information-feedback-seller.component.css']
})
export class InformationFeedbackSellerComponent implements OnInit, OnDestroy {
