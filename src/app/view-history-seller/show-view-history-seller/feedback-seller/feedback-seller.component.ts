...
@Component({
  selector: 'app-feedback-seller',
  templateUrl: './feedback-seller.component.html',
  styleUrls: ['./feedback-seller.component.css']
})
export class FeedbackSellerComponent implements OnInit ,OnDestroy {
